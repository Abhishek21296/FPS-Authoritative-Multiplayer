...
public class ClientHandle : MonoBehaviour
{
    ...
    public static void SpawnProjectile(Packet _packet)
    {
        ...
        Vector3 _projectilePosition = _packet.ReadVector3();
        int _thrownByPlayer = _packet.ReadInt();

        GameManager.instance.SpawnProjectile(_projectileId, _projectilePosition);
    ...
    public static void ProjectilePosition(Packet _packet)
    {
        ...
        {
            _projectile.transform.position = _projectilePosition;
        }
    }
    ...
    public static void ProjectileExploded(Packet _packet)
    {
        ...
        GameManager.projectiles[_projectileId].Explode(_projectilePosition);
    }
